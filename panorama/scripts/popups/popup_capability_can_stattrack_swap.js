...
var CapabilityCanStatTrackSwap = ( function()
{
	...
	var _Init = function()
	{
		...
		var elModel = $.GetContextPanel().FindChildInLayoutFile( 'StatTrackSwapToolModel' );
	...
	var _SetItemModel = function( idx )
	{
		...
		var modelPath = ItemInfo.GetModelPathFromJSONOrAPI( m_itemids[idx] );
	...
	var _SetUpSwapToolModel = function()
	{
		var elModel = $.GetContextPanel().FindChildInLayoutFile( 'StatTrackSwapToolModel' );
